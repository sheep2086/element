...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'element-ui-xuebei/src/utils/dom';
  import { isString, isHtmlElement } from 'element-ui-xuebei/src/utils/types';
