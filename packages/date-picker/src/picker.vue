...
import { formatDate, parseDate, isDateObject, getWeekNumber } from 'element-ui-xuebei/src/utils/date-util';
...
import merge from 'element-ui-xuebei/src/utils/merge';
...
const DEFAULT_FORMATS = {
  date: 'yyyy-MM-dd',
  month: 'yyyy-MM',
  datetime: 'yyyy-MM-dd HH:mm', // 学呗去掉:ss
  time: 'HH:mm', // 学呗去掉:ss
  week: 'yyyywWW',
  timerange: 'HH:mm', // 学呗去掉:ss
  daterange: 'yyyy-MM-dd',
  monthrange: 'yyyy-MM',
  datetimerange: 'yyyy-MM-dd HH:mm', // 学呗去掉:ss
  year: 'yyyy'
};
