...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-xuebei/src/utils/date-util';
  import ElScrollbar from 'element-ui-xuebei/packages/scrollbar';
  import RepeatClick from 'element-ui-xuebei/src/directives/repeat-click';
